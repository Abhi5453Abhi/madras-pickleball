        ...
        <form action={setCourtsAction} className="flex flex-col gap-3">
          ...
          <p className="text-meta text-text-3">
            {options.some((o) => o.takenBy)
              ? 'A greyed court belongs to another tournament that day. To use it here, take it off there first.'
              : 'Matches only ever go onto these courts. You can change them right up to the start.'}
          </p>
