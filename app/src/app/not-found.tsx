    ...
    <div className="min-h-dvh bg-ground">
      ...
      <main id="main" className="mx-auto flex w-full max-w-3xl flex-col gap-4 p-4">
        <p className="text-body text-text-2">
          It is probably an older tournament that has since been taken down, or a link that lost a
          character being passed on. Today&rsquo;s play is on the front page.
        </p>
